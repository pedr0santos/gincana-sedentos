...
export default function Login() {
  ...
  return <div className="auth-screen"><div className="glass-card auth-panel">
    ...
    <form className="mt-6 space-y-4" onSubmit={event => { event.preventDefault(); login.mutate({ email, password }); }}>
      ...
      <label><span className="mt-4 field-label">Senha</span><input className="dark-input" type="password" autoComplete="current-password" required value={password} onChange={event => setPassword(event.target.value)} /></label>
